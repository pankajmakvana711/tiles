        ...
        <div className="text-center mb-20">
          ...
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
            ...
            <span className="non-mobile-text">
              We at Tiles Zone have a team of creative designers working with
              the latest trends of style and the technicians of our company are
              dedicated to deliver technology-driven products at prices that are
              hard to believe.
            </span>
          </p>
        ...
        <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
          ...
          <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
            ...
            <div className="flex-grow">
              ...
              <p className="leading-relaxed text-base">
                Enabling Success through Profitable Models Empowering Associates
